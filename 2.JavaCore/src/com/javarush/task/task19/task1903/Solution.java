...
//            Integer tmp = data.getPhoneNumber();
//            String temp = tmp.toString();
//            while (temp.length() != 10)
//            {
//                temp = "s" + temp;
//            }
//            number = number + temp.substring(0, 3) + ")" + temp.substring(3, 6) + "-" + temp.substring(6, 9) + "-" + temp.substring(9);
//            return number; //For example: +38(050)123-45-67
//        }
